...
public class Instruction {
    ...
    public final static int
            LOADop = 0, LOADAop = 1, LOADIop = 2, LOADLop = 3,
            STOREop = 4, STOREIop = 5, CALLop = 6, CALLIop = 7,
            RETURNop = 8, PUSHop = 10, POPop = 11, JUMPop = 12,
...
// REGISTER NUMBERS
    ...
    public final static int
            ...
            LBr = 8, L1r = LBr + 1, L2r = LBr + 2,
            L3r = LBr + 3, L4r = LBr + 4, L5r = LBr + 5,
            L6r = LBr + 6, CPr = 15;
